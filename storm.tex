...
\usepackage[top=1cm, bottom=1.5cm, left=1.7cm, right=1.5cm]{geometry}
...
\begin{figure}[h]
	...
	\centering
	\caption{Descripci\'on general del modelo basado en un enfoque 'safety'}%Overview of the model-based safety approach
\end{figure}
...
\begin{figure}[h]
	...
	\centering
	\caption{Proceso para evaluar el modelo con Storm}%Overview of the storm-dft approach
\end{figure}
